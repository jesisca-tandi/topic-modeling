...
This project aims to understand customer sentiments in the airline industry from social media data. There are 2 parts:
1. Model development
2. Model deployment (prototpye on predictions on real-time data)
